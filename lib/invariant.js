 ...
 */
export function assertReplacementSmaller(originalChars, replacementChars) {
 ...
 */
export function assertRetrievable(present, hash) {
    if (!present)
        throw new Error(LOG_TAG + ': adopted replacement lost its retrievable original hash=' + hash);
}
