/**
 * Shared form model behind the headroom settings card — the same staged-form
 * machinery the shipped plugin cards (Shell / Agent loop / Web search) run on,
 * vendored here because the client-bundle purity gate forbids cross-package
 * value imports and the section package exports only types.
 *
